...
class ws4 extends StatefulWidget {
  const ws4({super.key});

  @override
  State<ws4> createState() => _ws4State();
}

class _ws4State extends State<ws4> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            RichText(text: TextSpan(text: "Peaky blinders season 1",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30,color: Colors.white
            ))),
            SizedBox(height: 10,),
            Padding(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  RichText(text: TextSpan(text: "Comedy  |",style: TextStyle(color: Colors.white)),),
            ...
            Container(
                height: 120,
                width: 330,
                child:ExpandableText("Tommy Shelby, a dangerous man, leads the Peaky Blinders, a gang based in Birmingham. Soon, Chester Campbell, an inspector, decides to nab him and put an end to the criminal activities.",style:TextStyle(color: Colors.white),collapseText:"show less",expandText: "show more",maxLines: 3,)
            ),
            Row(
              children: [
                Column(
