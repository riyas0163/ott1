      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            RichText(text: TextSpan(text: "Boo",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 40,color: Colors.white
            ))),
            Padding(
            ...
            Container(
                height: 90,
                width: 330,
                child: Text("Four friends are captivated by a horror novel during Halloween. However, reality becomes hazy as they read it, and they must confront the apparitional threat that manifests.",style: TextStyle(color: Colors.white),)),
            Row(
              children: [
                Column(
                  children: [
