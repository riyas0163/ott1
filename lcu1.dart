...
class lcu1 extends StatefulWidget {
  const lcu1({super.key});

  @override
  State<lcu1> createState() => _lcu1State();
}

class _lcu1State extends State<lcu1> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            RichText(text: TextSpan(text: "Leo",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 40,color: Colors.white
            ))),
            Padding(
            ...
            Container(
              ...
              child: TextButton(onPressed: (){},child: Text("Watch now"),),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Row(
            ...
            Container(
                height: 70,
                width: 330,
                child: Text("Leo, also known and marketed as Leo: Bloody Sweet is an upcoming Indian Tamil-language action thriller film directed by Lokesh Kanagaraj.",style: TextStyle(color: Colors.white),)),
            Row(
              children: [
                Column(
                  children: [
