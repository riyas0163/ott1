...
class lcu2 extends StatefulWidget {
  const lcu2({super.key});

  @override
  State<lcu2> createState() => _lcu2State();
}

class _lcu2State extends State<lcu2> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            RichText(text: TextSpan(text: "Vikram",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 40,color: Colors.white
            ))),
            Padding(
            ...
            Container(
                height: 80,
                width: 330,
                child: Text("A special agent investigates a murder committed by a masked group of serial killers. However, a tangled maze of clues soon leads him to the drug kingpin of Chennai.",style: TextStyle(color: Colors.white),)),
            Row(
              children: [
                Column(
                  children: [
