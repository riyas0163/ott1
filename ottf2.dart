      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            RichText(text: TextSpan(text: "Jailer",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 40,color: Colors.white
            ))),
            Row(
              children: [
                Row(
            ...
            Container(
                height: 70,
                width: 330,
                child: Text("Muthuvel Pandian, a stern yet compassionate jailer, sets out to stop a gang when they try to flee their leader from prison.",style: TextStyle(color: Colors.white),)),
            Row(
              children: [
                Column(
                  children: [
