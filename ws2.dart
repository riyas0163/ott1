...
class ws2 extends StatefulWidget {
  const ws2({super.key});

  @override
  State<ws2> createState() => _ws2State();
}

class _ws2State extends State<ws2> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            RichText(text: TextSpan(text: "After",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30,color: Colors.white
            ))),
            SizedBox(height: 10,),
            Padding(
            ...
            Container(
                height: 70,
                width: 330,
                child:ExpandableText("Author Hardin Scott travels to Portugal in an attempt to make Natalie forgive him for what he did to her.",style:TextStyle(color: Colors.white),collapseText:"show less",expandText: "show more",maxLines: 3,)
            ),
            Row(
              children: [
                Column(
